...
import { Home, Settings, LogOut, Plus, ArrowLeft } from "lucide-react";
...
const HeaderWithSettings = ({
  ...
  if (isAuthenticated) {
    return <header className="fixed top- -2 left-0 right-0 z-50 bg-card/80 backdrop-blur-md border-b border-border" style={{ position: 'fixed', top: -2 }}>
          ...
          <div className="flex items-center justify-between px-0 py-[10px]">
            ...
            <nav className="flex items-center space-x-4">
              ...
              <div className="hidden lg:flex items-center space-x-4">
                ...
                <Button variant="ghost" size="sm" onClick={() => navigate("/create")} className="flex items-center gap-2">
  ...
  return <header className="fixed top-0 left-0 right-0 z-50 bg-card/20 backdrop-blur-md border-b border-border/50">
